...
var setup = function () {
    ...
    this.sessionSortKey = this.data.settings.sessionSortKey;
    this.sessionSortDirectionKey = this.data.settings.sessionSortDirectionKey;
    this.noSort = this.data.settings.noSort;
    ...
    var sortDirection = 1;
    if (Session.get(this.sessionSortKey)){
        sortKey = Session.get(this.sessionSortKey);
    }

    if (Session.get(this.sessionSortDirectionKey)){
        sortDirection = Session.get(this.sessionSortDirectionKey);
    }
...
Template.reactiveTable.events({
    'click .reactive-table .sortable': function (event) {
        ...
        Session.set(template.sessionSortDirectionKey, template.data.sortDirection.get())
        Session.set(template.sessionSortKey, template.data.sortKey.get())
    },
